...
//  TurboList
//
//  Created by Rahaf ALghuraibi on 10/05/1446 AH.
//

import SwiftUI
import CloudKit

struct FetchedListView: View {
...
struct FetchedListView_Previews: PreviewProvider {
    static var previews: some View {
        ...
        FetchedListView(categories: groceryItems, listID: mockListID, listName: mockListName, createListViewModel: createListViewModel)
